...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<h1 to='/' className="btn btn-ghost text-xl font-mono font-bold">Blog <span className="font-bold text-purple-600">Hub</span></h1>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-600 font-bold">© 2024 Company All rights reserved Under Blog Hub.</div>
</footer>
    );
};
