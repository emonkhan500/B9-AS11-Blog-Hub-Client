...
const Footer = () => {
    return (
        <footer className="px-4 mt-44 divide-y dark:bg-gray-100 dark:text-gray-800 w-full">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-4xl font-semibold">Blog List</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide text-xl font-semibold uppercase dark:text-gray-900">Product</h3>
			...
			<div className="space-y-3">
				<h3 className="uppercase text-xl font-semibold dark:text-gray-900">Developers</h3>
				<ul className="space-y-1">
					<li>
	...
	<div className="py-6 text-sm text-center dark:text-gray-600 font-bold">© 2024 Company All rights reserved Under Blog List.</div>
</footer>
    );
};
